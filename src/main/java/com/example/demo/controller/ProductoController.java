...
public class ProductoController {
    ...
    public String buscarProductoPorId(HttpSession session, @RequestParam(value = "idProducto", required = false) Integer idProducto, Model model) {
    ...
    public String registrarCategoria(@ModelAttribute("categoria") @Valid CategoriaEntity categoria, BindingResult result) {
        if (result.hasErrors()) {
            return "registrar_categoria";
        }
